...
<template>
  <div
    class="mb-2.5 rounded-[7px] bg-slate-200 px-2 py-1.5 text-sm text-slate-900 flex items-center gap-2"
  >
    ...
    <button
      class="items-end flex-shrink-0 p-1 rounded-md hover:bg-slate-400"
      @click="$emit('dismiss')"
    >
