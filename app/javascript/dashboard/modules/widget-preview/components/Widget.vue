...
<template>
  <div>
    ...
    <div
      ...
      class="widget-wrapper flex flex-col justify-between rounded-lg shadow-md bg-slate-100 dark:bg-slate-100 h-[31.25rem] w-80"
    >
      ...
      <div>
        ...
        <div class="py-2.5 flex justify-center">
          <a
            class="items-center gap-0.5 text-slate-900 cursor-pointer flex filter grayscale opacity-90 hover:grayscale-0 hover:opacity-100 text-xxs"
          >
            <img
