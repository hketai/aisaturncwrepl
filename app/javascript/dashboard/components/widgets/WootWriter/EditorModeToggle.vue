...
<template>
  <button
    class="flex items-center w-auto h-8 p-1 transition-all border rounded-full bg-slate-900/10 group relative duration-300 ease-in-out z-0"
    :disabled="disabled"
    :class="{
  ...
  >
    ...
    <div
      class="absolute shadow-sm rounded-full h-6 w-[var(--chip-width)] ease-in-out translate-x-[var(--translate-x)] rtl:translate-x-[var(--rtl-translate-x)] bg-slate-100"
      :class="{
