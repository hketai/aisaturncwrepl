...
<template>
  <select
    v-model="activeValue"
    class="w-32 h-6 py-0 pl-2 pr-6 mx-1 my-0 text-xs border border-solid bg-slate-200 dark:bg-slate-300 border-slate-300 dark:border-slate-300 text-slate-900"
    @change="onTabChange()"
  >
