...
const statusTextColor = computed(() => ({
  'text-teal-900': isActive.value,
  'text-slate-900': !isActive.value,
}));
  ...
  <CardLayout layout="row">
    <div class="flex flex-col items-start justify-between flex-1 min-w-0 gap-2">
      <div class="flex justify-between gap-3 w-fit">
        <span
          class="text-base font-medium capitalize text-slate-900 line-clamp-1"
        >
          {{ title }}
        </span>
        <span
      ...
      <div
        ...
        class="text-sm text-slate-900 line-clamp-1 [&>p]:mb-0 h-6"
      />
