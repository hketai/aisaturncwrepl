...
<template>
  <div
    class="w-[25rem] z-50 min-w-0 absolute top-10 ltr:right-0 rtl:left-0 bg-slate-900/15 backdrop-blur-[100px] rounded-xl border border-slate-300 shadow-md max-h-[80vh] overflow-y-auto"
  >
    <div class="p-6 flex flex-col gap-6">
      <h3 class="text-base font-medium text-slate-900 flex-shrink-0">
