...
<template>
  ...
  >
    <NextButton
      ...
      @click="onClose"
    />
    <div class="flex flex-col gap-6 divide-y divide-slate-400">
      <div class="flex flex-col gap-6">
        ...
        <div class="flex items-center gap-3 w-full">
          <span
            class="min-h-10 px-3 py-2.5 inline-flex items-center w-full text-sm bg-transparent border rounded-lg text-slate-900 border-slate-400"
          >
            {{ subdomainCNAME }}
          </span>
          <NextButton
