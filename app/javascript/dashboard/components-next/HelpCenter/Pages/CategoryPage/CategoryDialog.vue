...
<template>
  <div
    class="w-[25rem] absolute top-10 ltr:right-0 rtl:left-0 bg-slate-900/15 backdrop-blur-[100px] p-6 rounded-xl border border-slate-300 shadow-md flex flex-col gap-6"
  >
