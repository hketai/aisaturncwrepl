...
<template>
  <div
    class="pt-5 pb-3 bg-slate-900/15 backdrop-blur-[100px] outline outline-slate-300 outline-1 z-50 absolute w-[27.5rem] rounded-xl shadow-md flex flex-col gap-4"
  >
    <div
      class="flex items-center justify-between gap-4 px-6 pb-3 border-b border-slate-900/10"
    >
      <div class="flex flex-col gap-1">
        <div class="flex items-center gap-2">
          <h2
            class="text-base font-medium cursor-pointer text-slate-900 w-fit hover:underline"
          ...
          <Button
            ...
            icon-lib="lucide"
            size="sm"
            class="!w-6 !h-6 hover:bg-slate-100 text-slate-900 !p-0.5 rounded-md"
      ...
      <Button
        ...
        icon="i-lucide-plus"
        size="sm"
        class="!bg-slate-900/10 hover:!bg-slate-900/15"
    ...
    <div v-if="portals.length > 0" class="flex flex-col gap-2 px-4">
      <Button
        ...
        class="!justify-end !px-2 !py-2 hover:!bg-slate-900/10 [&>.i-lucide-check]:text-teal-900 h-9"
        size="sm"
      ...
      >
        ...
        <span class="text-sm font-medium truncate text-slate-900">
          {{ portal.name || '' }}
        </span>
        <Avatar
          v-if="portal"
