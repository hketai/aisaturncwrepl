...
<template>
  <div v-if="hasContactAttributes" class="flex flex-col gap-6 px-6 py-6">
    ...
    <div v-if="!hasNoUnusedAttributes" class="flex items-center gap-3">
      <div class="flex-1 h-[1px] bg-slate-400" />
    ...
    <div class="flex flex-col gap-3">
      <div v-if="!hasNoUnusedAttributes" class="relative">
        ...
        <input
          ...
          "
          class="w-full h-8 py-2 pl-10 pr-2 text-sm reset-base outline-none border-none rounded-lg bg-slate-900/10 dark:bg-slate-100 text-slate-900"
        />
      </div>
      <div
