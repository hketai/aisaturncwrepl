...
<template>
  <div
    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 px-6 py-5 shadow outline-1 outline outline-slate-300 rounded-xl bg-slate-200"
  >
    <div
    ...
    >
      ...
      <div class="mt-4 h-72">
        ...
        <div v-else class="flex items-center justify-center h-72">
          ...
          />
          <span v-else class="text-sm text-slate-900">
