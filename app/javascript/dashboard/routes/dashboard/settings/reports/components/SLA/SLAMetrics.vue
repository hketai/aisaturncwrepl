...
<template>
  <div
    class="flex sm:flex-row flex-col w-full gap-4 sm:gap-14 shadow outline-1 outline outline-slate-300 rounded-xl bg-slate-200 px-6 py-5"
  >
    <SLAMetricCard
    ...
    <div class="w-full sm:w-px bg-slate-400" />
    <SLAMetricCard
