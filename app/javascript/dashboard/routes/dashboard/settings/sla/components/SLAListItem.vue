...
<template>
  <BaseSettingsListItem
    class="sm:divide-x sm:divide-slate-300"
    :title="slaName"
  ...
  >
    ...
    <template #rightSection>
      <div
        class="flex items-center divide-x rtl:divide-x-reverse sm:rtl:!border-l-0 sm:rtl:!border-r sm:rtl:border-solid sm:rtl:border-slate-300 gap-1.5 w-fit sm:w-full sm:gap-0 sm:justify-between divide-slate-300"
      >
