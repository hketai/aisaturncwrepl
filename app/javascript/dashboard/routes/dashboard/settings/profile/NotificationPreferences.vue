  ...
  <div id="profile-settings-notifications" class="flex flex-col gap-6">
    ...
    <div class="hidden sm:block">
      ...
      >
        ...
        >
          <span class="text-sm font-normal normal-case text-slate-900">
        ...
        >
          <span class="text-sm font-medium normal-case text-slate-900">
        ...
        >
          <div class="flex items-center justify-between gap-1">
            <span
              class="text-sm font-medium normal-case text-slate-900 whitespace-nowrap"
            >
    ...
    <div
      class="flex items-center justify-between w-full gap-2 p-4 border border-solid border-slate-300 rounded-xl"
    >
