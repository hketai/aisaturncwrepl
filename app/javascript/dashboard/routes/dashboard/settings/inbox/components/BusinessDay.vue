...
<template>
  <div
    class="day-wrap flex py-2 gap-1 items-center px-0 min-h-[3rem] box-content border-b border-solid border-slate-300"
  >
    ...
    >
      ...
      <div v-if="hasError" class="date-error pt-1">
        <span class="error text-xs text-red-800">{{
    ...
    <div
      v-else
      class="flex items-center flex-shrink-0 flex-grow text-sm text-slate-900"
    >
      <span>
    ...
    <div>
      <span
        ...
        class="label bg-indigo-600/10 dark:bg-indigo-600/30 text-indigo-700 text-xs inline-block px-2 py-1 rounded-lg cursor-default whitespace-nowrap"
      >
