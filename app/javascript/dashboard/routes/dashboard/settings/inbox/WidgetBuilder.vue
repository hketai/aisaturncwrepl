    ...
    <div class="flex p-2.5">
      ...
      <div class="w-100 lg:w-3/5">
        ...
        <div
          ...
          class="flex flex-col items-center justify-end min-h-[40.625rem] mx-5 mb-5 p-2.5 bg-slate-200 rounded-lg"
        >
          <Widget
        ...
        <div
          v-else
          class="mx-5 p-2.5 bg-slate-200 rounded-lg dark:bg-slate-300"
        >
