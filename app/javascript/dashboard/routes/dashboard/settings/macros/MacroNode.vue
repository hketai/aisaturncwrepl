...
<template>
  <div class="relative flex items-start w-full min-w-0 basis-full">
    ...
    />
    <div
      class="flex-grow p-2 ltr:mr-2 rtl:ml-2 rounded-md shadow-sm outline outline-1 outline-slate-300"
      :class="
        errorKey
          ? 'animate-shake bg-red-700/20 outline-red-400 dark:outline-red-400'
