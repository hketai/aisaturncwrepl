# -*- encoding: utf-8 -*-
# stub: judoscale-sidekiq 1.8.2 ruby lib

Gem::Specification.new do |s|
  s.name = "judoscale-sidekiq".freeze
  s.version = "1.8.2"
  ...
  s.summary = "Autoscaling for Sidekiq workers.".freeze

  s.installed_by_version = "3.4.10" if s.respond_to? :installed_by_version

  s.specification_version = 4

  s.add_runtime_dependency(%q<judoscale-ruby>.freeze, ["= 1.8.2"])
