...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<rspec-sidekiq>.freeze, ["~> 5.0"])
  s.add_development_dependency(%q<rubocop-shopify>.freeze, ["~> 2.10"])
  s.add_development_dependency(%q<semver2>.freeze, ["~> 3.4"])
  s.add_development_dependency(%q<solargraph>.freeze, ["~> 0.54.0"])
